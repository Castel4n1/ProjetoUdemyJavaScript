...
document.getElementById("service-previous").onclick = function(){
  ...
  document.getElementById("service-text").innerHTML = our_services[servico_anterior].title;
...
document.getElementById("service-next").onclick = function(){
  ...
  document.getElementById("service-text").innerHTML = our_services[servico_seguinte].title;
...
document.getElementById("current_year").innerHTML = ano_atual;
  ...
  //AIzaSyDBgdlpbSwTLFib2WE0RFFHpkhcSxv1DEc
